          ...
          >
             {hasSheetContent ? (
                <>
                  ...
                  {((item.data.cover && (item.data.cover.expandedPosition === 'header' || !item.data.cover.expandedPosition)) || 
                    ...
                    <div className="relative w-full h-64 sm:h-80">
                       ...
                       {item.data.cover?.type === 'video' ? (
                          ...
                          <img 
                              src={item.data.cover?.url || (item.data as any).heroImageUrl} 
                  ...
                  >
                    ...
                    {item.data.cover && item.data.cover.expandedPosition === 'content' && (
                    ...
                    <div dangerouslySetInnerHTML={{ __html: item.data.sheetContent }} />
                  </motion.div>
